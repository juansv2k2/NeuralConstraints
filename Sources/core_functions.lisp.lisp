...
( defun binary-to-combined-fraction-mod
	( binary-list )
	( let*
		(
			( rational-binary
				( subseq binary-list 0 10 )
				)
			( integer-binary
				( subseq binary-list 10 14 )
				)
			( rational-part
				( binary-to-rational rational-binary )
				)
			( integer-part
				( binary-to-integer integer-binary )
				)
			)
		( list rational-part integer-part )
		)
	)
( defun binary-to-rational
	( binary-list )
	( let*
		(
			( sign-bit
			...
			( numerator
				( binary-list-to-integer binary-num )
				)
			( denominator-index
				( binary-list-to-integer binary-den )
				)
			( denominator-values '
...
( defun binary-list-to-integer
	...
	( reduce
		...
		binary-list :initial-value 0 )
	)
( defun binary-2-combined-list
	( binary-list )
	( mapcar #'binary-to-combined-fraction-mod binary-list )
	)
( defun combined-fraction-mod-to-14-bit
	( fraction-list )
	( let*
		(
			( rational-part
			...
			( rational-binary
				( rational-to-10bit-representation rational-part )
				)
			( integer-part
				( second fraction-list )
				)
			( integer-binary
				( if
					( eq integer-part
			...
			( binary-representation
				( append rational-binary integer-binary )
				)
			)
		binary-representation )
	)
...
( defun combined-list-2-binary
	( binary-list )
	( patch-work::flat
		( mapcar #'combined-fraction-mod-to-14-bit binary-list )
		)
	)
( defun mod-second-element
	( lista )
	( let
		(
			( rational-part
