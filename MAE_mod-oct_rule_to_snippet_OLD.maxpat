...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 827.0, 347.5, 124.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 187.866383224725723, 13.73856694996357, 154.0, 20.0 ],
					"text" : "MAE_Mod-Oct_Rule_OLD",
					"textjustification" : 2
				}
