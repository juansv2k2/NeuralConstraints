...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 628.25, 168.0, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 558.75, 168.0, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1051.0, 55.0, 59.0, 22.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					"comment" : "inputs/targets (list w/two ints)",
					"id" : "obj-48",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1051.0, 17.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 604.0, 349.5, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 484.0, 616.5, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1051.0, 585.0, 80.0, 22.0 ],
					"text" : "[ 2 2 -4 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1112.0, 534.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1112.0, 752.0, 169.0, 22.0 ],
					"text" : "[ 60 122 186 246 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1112.0, 470.5, 442.0, 49.0 ],
					"text" : "( progn (defun calculate-intervals ( lst ) (if (>= (length lst) 2) (let ((prev (first lst))) (mapcar (lambda (x) (let ((interval (- x prev))) (setq prev x) interval)) (rest lst))) t )) (calculate-intervals ( list 60 62 64 60 )))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1228.0, 393.0, 72.0, 22.0 ],
					"text" : "60 62 64 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.943954487641633, 865.212899416685104, 29.5, 22.0 ],
					"text" : "nn1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 89.0, 817.676572293043137, 87.943954487641633, 22.0 ],
					"text" : "t l b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.471977243820817, 865.212899416685104, 29.5, 22.0 ],
					"text" : "nn"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 866.0, 752.0, 174.0, 22.0 ],
					"text" : "s #0_MAE_intervals_rule_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.5, 4.0, 172.0, 22.0 ],
					"text" : "r #0_MAE_intervals_rule_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 199.5, 29.5, 22.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 540.0, 130.0, 102.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.0, 563.0, 121.0, 22.0 ],
					"text" : "a b c d e f g"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 699.0, 670.5, 29.5, 22.0 ],
					"text" : "g h"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 699.0, 512.5, 51.0, 22.0 ],
					"text" : "index -2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 607.5, 616.5, 121.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80300
					}
,
...
, 			{
				"box" : 				{
					...
					"reg_data_0000000000" : [ "[", "lambda", "[", "a", "b", "c", "d", "e", "f", "g", "h", "]", "[", "let*", "[", "[", "mean-absolute-error", "[", "snn:mean-absolute-error", "nn", "[", "list", "[", "normalize-binary", "[", "apply", "#'vector", "[", "patch-work::flat", "[", "interv-to-binary", "[", "list", "a", "b", "c", "d", "e", "f", "g", "]", "]", "]", "]", "]", "]", "[", "list", "[", "normalize-binary", "[", "apply", "#'vector", "[", "patch-work::flat", "[", "interv-to-binary", "[", "list", "g", "h", "]", "]", "]", "]", "]", "]", "]", "]", "[", "weight1", "[", "/", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1072693248, "[", "+", "[", "log", "[", "+", "mean-absolute-error", 1, "]", "]", "_x_x_x_x_bach_float64_x_x_x_x_", 2696277389, 1051772663, "]", "]", "]", "]", "[", "print", "weight1", "]", "]", "]" ],
					"reg_data_count" : [ 1 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80300
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 452.0, 105.0, 22.0 ],
					"text" : "a b c d e f g h"
				}
...
, 			{
				"box" : 				{
					...
					"reg_data_0000000000" : [ "[", "lambda", "[", "lst", "]", "[", "let*", "[", "[", "mean-absolute-error", "[", "snn:mean-absolute-error", "nn", "[", "list", "[", "normalize-binary", "[", "apply", "#'vector", "[", "patch-work::flat", "[", "interv-to-binary", "[", "list", "input", "]", "]", "]", "]", "]", "]", "[", "list", "[", "normalize-binary", "[", "apply", "#'vector", "[", "patch-work::flat", "[", "interv-to-binary", "[", "list", "target", "]", "]", "]", "]", "]", "]", "]", "]", "[", "weight1", "[", "/", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1072693248, "[", "+", "[", "log", "[", "+", "mean-absolute-error", 1, "]", "]", "_x_x_x_x_bach_float64_x_x_x_x_", 2696277389, 1051772663, "]", "]", "]", "]", "[", "print", "weight1", "]", "]", "]" ],
					"reg_data_count" : [ 1 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80300
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 493.5, 676.5, 321.5, 676.5, 321.5, 552.0, 279.5, 552.0 ],
					"source" : [ "obj-103", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 413.5, 693.5, 344.5, 693.5, 344.5, 441.0, 295.5, 441.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 386.5, 706.5, 242.5, 706.5, 242.5, 58.0, 98.5, 58.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 549.5, 192.0, 613.5, 192.0 ],
					"order" : 0,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 493.5, 573.5, 617.0, 573.5 ],
					"order" : 0,
					"source" : [ "obj-25", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 139.0, 49.0, 98.5, 49.0 ],
					"order" : 1,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 549.5, 314.0, 613.5, 314.0 ],
					"order" : 1,
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 549.5, 400.5, 708.5, 400.5 ],
					"order" : 0,
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 549.5, 352.0, 386.5, 352.0 ],
					"order" : 2,
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 719.0, 659.5, 708.5, 659.5 ],
					"order" : 1,
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 708.5, 579.0, 617.0, 579.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 708.5, 722.5, 265.25, 722.5, 265.25, 657.0, 188.333333333333314, 657.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"midpoints" : [ 386.5, 598.5, 617.0, 598.5 ],
					"order" : 0,
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 22.5, 944.0, 98.5, 944.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1060.5, 157.0, 568.25, 157.0 ],
					"source" : [ "obj-78", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1100.5, 163.0, 637.75, 163.0 ],
					"source" : [ "obj-78", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 304.0, 848.871682733297348, 179.943954487641633, 848.871682733297348 ],
					"source" : [ "obj-82", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-23" : [ "live.numbox[22]", "live.numbox", 0 ],
			"obj-29" : [ "live.numbox[24]", "live.numbox", 0 ],
			"obj-34" : [ "live.numbox[23]", "live.numbox", 0 ],
			"obj-46" : [ "live.tab[2]", "live.tab[1]", 0 ],
			"obj-54" : [ "live.tab[1]", "live.tab[1]", 0 ],
			"obj-74" : [ "live.numbox[25]", "live.numbox", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
